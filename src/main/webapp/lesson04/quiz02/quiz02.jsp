...
<%
	// DB 연결
	MysqlService mysql = MysqlService.getInstance(); // 객체 가져오기
	mysql.connection(); // 연결하기
			...
			<table class="table text-center">
				...
				%>		
					<tr>
						...
						<td>
							<a href="<%= result.getString("url")%>" target="_blank"> <%-- target="_blank" : 새 탭에 생긴다 --%>
							<%= result.getString("url")%></a>
						</td>
